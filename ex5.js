...
let segundoNumero = parseInt(prompt("Digite o primeiro número: "));
let terceiroNumero = parseInt(prompt("Digite o primeiro número: "));
...
//Desafio
//Informe se os números informando estão em
