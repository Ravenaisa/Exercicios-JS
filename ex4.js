...
let nota1 = parseFloat(promp("Digite a primeira nota"))

let nota2 = parseFloat(promp("Digite a segunda nota"))

let nota3 = parseFloat(promp("Digite a terceira nota"))

let nota4 = parseFloat(promp("Digite a quarta nota"))
